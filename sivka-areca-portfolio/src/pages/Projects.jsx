...
export default function Projects() {
  ...
  return (
    <>
      <Helmet>
        <title>Projects | Sivka Areca Enterprises – PEB & Industrial Works</title>
        <meta
          name="description"
          content="Explore completed projects by Sivka Areca Enterprises including PEB buildings, railway infrastructure, exhaust towers, and sheet metal works."
        />
        <link rel="canonical" href="https://www.sivkaareca.com/projects" />
      </Helmet>
