...
export default function Products() {
  ...
  return (
    <>
      <Helmet>
        <title>Core Expertise & Products | Sivka Areca Enterprises</title>
        <meta
          name="description"
          content="Specialized engineering solutions including PEB manufacturing, custom containers, industrial exhaust towers, and precision sheet metal works."
        />
        <link rel="canonical" href="https://www.sivkaareca.com/products" />
      </Helmet>
