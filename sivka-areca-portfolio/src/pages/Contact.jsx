...
export default function Contact() {
  ...
  return (
    <>
      <Helmet>
        <title>Contact Us | Sivka Areca Enterprises, Belagavi</title>
        <meta
          name="description"
          content="Contact Sivka Areca Enterprises in Khanapur, Belagavi for steel fabrication, PEB structures, and custom engineering solutions."
        />
        <link rel="canonical" href="https://www.sivkaareca.com/contact" />
      </Helmet>
                ...
                <div className="pt-4 border-t border-gray-200">
                  <div className="space-y-3">
                    ...
                    >
                      ...
                      <span>+91 8104478208 / +91 95912 53590</span>
                    </motion.a>
                    <motion.a
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  >
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-12 pr-4 py-4 border rounded-xl bg-white text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-all ${errors.name ? 'border-red-300 ring-2 ring-red-200' : 'border-gray-300'
                          }`}
                      />
                    </div>
                    {errors.name && (
                  ...
                  >
                    <div className="relative">
                      ...
                      <input
                        ...
                        value={form.email}
                        onChange={handleChange}
                        className={`w-full pl-12 pr-4 py-4 border rounded-xl bg-white text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-all ${errors.email ? 'border-red-300 ring-2 ring-red-200' : 'border-gray-300'
                          }`}
                      />
                    </div>
                    {errors.email && (
                ...
                >
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={6}
                    className={`w-full px-4 py-4 border rounded-xl bg-white text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-all resize-none ${errors.message ? 'border-red-300 ring-2 ring-red-200' : 'border-gray-300'
                      }`}
                  />
                  {errors.message && (
                    <motion.div
