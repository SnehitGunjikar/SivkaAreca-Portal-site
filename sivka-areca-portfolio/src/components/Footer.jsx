...
export default function Footer() {
  ...
  return (
    <footer className="bg-neutral-900 border-t border-neutral-800 mt-16 text-gray-300">
      ...
      >
        {/* Top grid */}
        <div className="py-8 md:py-16 grid gap-8 sm:grid-cols-2 md:grid-cols-4">
          {/* Company Info */}
          <section aria-labelledby="footer-company" className="space-y-3">
            <h3 id="footer-company" className="sr-only">Sivka Areca Enterprises</h3>
            <img src={brandLogo} alt="Sivka Areca Enterprises" className="h-10 md:h-12 brightness-110 contrast-110 saturate-110 drop-shadow-sm" />
            <p className="text-sm md:text-[15px] text-gray-300">Innovating Steel Structures with Precision & Excellence</p>
            <address className="not-italic text-sm md:text-[15px] space-y-1 text-gray-300">
              <p>G.P.C. No. 414/34, Shivaji Nagar, Khanapur – 591302, Belagavi, Karnataka</p>
              <p>GSTIN: 29FMNPP9114A1ZS</p>
              <p>Contact: +91 96864 20150 / +91 95912 53590</p>
              <p>Email: <a href="mailto:sivkaareca@gmail.com" className="hover:text-brand-400">sivkaareca@gmail.com</a></p>
            </address>
          </section>
      ...
      <button
        ...
        title="Back to Top"
        className="fixed bottom-6 right-6 z-50 h-10 w-10 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white/20 text-white shadow-lg grid place-content-center focus:outline-none focus:ring-2 focus:ring-white/40 focus:ring-offset-2 focus:ring-offset-neutral-900"
      >
